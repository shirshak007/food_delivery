...
var x = document.f1.email.value;
	...
	document.f1.name.value=""
	   ...
	   return false
		...
		if(document.f1.r_type.value=="")
	{
	   alert("Offer field should not be empty");
	   document.f1.r_type.focus();
	   return false
	}
	
	if(document.f1.owner_ssn.value=="")
	{
	   alert("SSN field should not be empty");
	   document.f1.owner_ssn.focus();
	   return false
	}
...
<body>
<header><h1>Restaurant Registration</h1></header>
<center>
<nav>

<form action="rsignupsuc.php" method=post name=f1 onsubmit="return func1()">

	Restaurant ID<font color=red>*</font>(Auto Generated)
...
$sql = "SELECT * FROM restaurant ORDER BY R_ID DESC LIMIT 1";
...
?>">
	...
	You Offer(eg: Indian Chinese separated by space)<font color=red>*</font>
	<input type=text name=r_type>

	<br>
	
	<strong>
	Package(The more you Pay, The more you Get)
	<br>
	<input type="radio" name="package" value="1"> $
	<br><input type="radio" name="package" value="2"> $$
	<br><input type="radio" name="package" value="3" checked> $$$ (Preferred)
	<br><input type="radio" name="package" value="4">$$$$
	<br><input type="radio" name="package" value="5">$$$$$
	<br>
	Owner SSN<font color=red>*</font>
