...
$sql = "SELECT delivery_boy.D_B_NAME as dbname, delivery_boy.D_B_ID as dbid,COUNT(food_delivery.ORDER_ID) as nooforders from delivery_boy,food_delivery WHERE delivery_boy.D_B_ID=food_delivery.D_B_ID group by food_delivery.D_B_ID order by nooforders desc";
	?>
<table id="report1">
	<tr>
    <th>D_B ID</th>
...
<div class="alert">
  ...
  <strong>Delivery Boy by whom MOST ORDERS ARE Delivered</strong>
