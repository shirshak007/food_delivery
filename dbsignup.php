...
<body>
<header><h1>Delivery Boy Registration</h1></header>
<center>
<nav>

<form action="dbsignupsuc.php" method=post name=f1 onsubmit="return func1()">
<strong>
	D_Boy ID<font color=red>*</font>(Auto Generated)
	<input type=text name=dbid readonly value="<?php
...
$sql = "SELECT * FROM delivery_boy ORDER BY D_B_ID DESC LIMIT 1";
