...
<header><h1>Restaurant Login</h1></header>

<nav>
<form action="rlogincheck.php" method=post>
Restaurant ID/Email:&nbsp&nbsp<input type=text name=id>
