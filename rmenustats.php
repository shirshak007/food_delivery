...
if ($conn->connect_error) 
    die();
$r_id=$_SESSION["r_id"];
$sql = "select menu.F_ID as fid,menu.F_DESC as fdesc, menu.FOOD_TYPE as ftype, menu.PRICE as price  , SUM(menu_order.QUANTITY) as qty,SUM(menu_order.QUANTITY)*menu.PRICE as income from menu,menu_order where menu_order.FOOD_ID=menu.F_ID and menu.R_ID='$r_id' GROUP BY menu_order.FOOD_ID order by income desc";
	?>
<table id="report1">
	<tr>
    <th>Food ID</th>
...
<div class="alert">
  ...
  <strong>ITEMS SOLD STATS</strong>
