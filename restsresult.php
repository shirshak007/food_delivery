...
$sql = "SELECT * from restaurant,r_loc,rrloc,r_offer where restaurant.R_ID=rrloc.R_ID and rrloc.R_LOC_ID=r_loc.R_LOC_ID and r_offer.R_ID=restaurant.R_ID and r_offer.PINCODE='$c_pin' and restaurant.R_NAME like '%$nm%' order by restaurant.PACKAGE DESC;";
	?>
<table id="report1">
	<tr>
    <th>Image</th>
...
<a class="w3-right w3-btn w3-block" href="rmenu.php?r_id=<?php echo $row["R_ID"]?>"><i class="fa fa-angle-double-right w3-margin-right"><img src="img/open.gif" width=100 height=50></i></a>
</div>
</div></td>
	</tr>
	<?php
